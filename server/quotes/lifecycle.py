...
# Backward compatibility / legacy aliases
QUOTE_LEGACY_MAP = {
    "DRAFT": QUOTE_STATUS_REQUESTED,
    "PENDING": QUOTE_STATUS_REQUESTED,
    "GENERATED": QUOTE_STATUS_AI_ANALYZED,
    "PENDING_REVIEW": QUOTE_STATUS_CUSTOMS_REVIEWED,
    "APPROVED": QUOTE_STATUS_FINAL_QUOTE_SENT,
    "SENT": QUOTE_STATUS_FINAL_QUOTE_SENT,
    "ISSUED": QUOTE_STATUS_FINAL_QUOTE_SENT,
    "BOOKED": QUOTE_STATUS_ACCEPTED,
    "CONFIRMED": QUOTE_STATUS_ACCEPTED,
}

QUOTE_TRANSITIONS = {
    QUOTE_STATUS_REQUESTED: {QUOTE_STATUS_AI_ANALYZED, QUOTE_STATUS_REJECTED},
    QUOTE_STATUS_AI_ANALYZED: {QUOTE_STATUS_CUSTOMS_REVIEWED, QUOTE_STATUS_CUSTOMS_FLAGGED, QUOTE_STATUS_FINAL_QUOTE_SENT, QUOTE_STATUS_REJECTED},
    QUOTE_STATUS_CUSTOMS_REVIEWED: {QUOTE_STATUS_FINAL_QUOTE_SENT, QUOTE_STATUS_REJECTED},
    QUOTE_STATUS_CUSTOMS_FLAGGED: {QUOTE_STATUS_CUSTOMS_REVIEWED, QUOTE_STATUS_REJECTED},
    QUOTE_STATUS_FINAL_QUOTE_SENT: {QUOTE_STATUS_ACCEPTED, QUOTE_STATUS_REJECTED},
