...
QUOTE_TRANSITIONS = {
    QUOTE_STATUS_DRAFT: {QUOTE_STATUS_GENERATED, QUOTE_STATUS_REJECTED},
    QUOTE_STATUS_GENERATED: {QUOTE_STATUS_PENDING_REVIEW, QUOTE_STATUS_APPROVED, QUOTE_STATUS_SENT, QUOTE_STATUS_REJECTED},
    QUOTE_STATUS_PENDING_REVIEW: {QUOTE_STATUS_APPROVED, QUOTE_STATUS_REJECTED, QUOTE_STATUS_SENT},
    QUOTE_STATUS_APPROVED: {QUOTE_STATUS_SENT, QUOTE_STATUS_ACCEPTED, QUOTE_STATUS_REJECTED},
...
def normalize_quote_status(status_str: str) -> str:
    """Normalize status string handling legacy aliases."""
    if not status_str:
        return QUOTE_STATUS_PENDING_REVIEW
    norm = status_str.strip().upper()
