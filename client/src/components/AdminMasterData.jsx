...
const MASTER_COLLECTIONS_SEED = {
  ...
  carriers: [
    { carrierCode: "MAEU", carrierName: "Maersk Line", mode: "OCEAN", serviceTypes: ["FCL", "LCL"], reliabilityScore: 94, contractTier: "CONTRACT", apiEnabled: true, contactEmail: "ops@maersk.example", isActive: true },
    { carrierCode: "CMDU", carrierName: "CMA CGM", mode: "OCEAN", serviceTypes: ["FCL", "REEFER"], reliabilityScore: 88, contractTier: "CONTRACT", apiEnabled: true, contactEmail: "ops@cma-cgm.example", isActive: true },
    { carrierCode: "HLAG", carrierName: "Hapag-Lloyd", mode: "OCEAN", serviceTypes: ["FCL", "LCL"], reliabilityScore: 91, contractTier: "CONTRACT", apiEnabled: true, contactEmail: "ops@hapag-lloyd.example", isActive: true },
    { carrierCode: "EK", carrierName: "Emirates SkyCargo", mode: "AIR", serviceTypes: ["AIR_GEN", "AIR_EXPRESS"], reliabilityScore: 95, contractTier: "CONTRACT", apiEnabled: true, contactEmail: "ops@emirates-skycargo.example", isActive: true },
    { carrierCode: "LH", carrierName: "Lufthansa Cargo", mode: "AIR", serviceTypes: ["AIR_GEN"], reliabilityScore: 92, contractTier: "CONTRACT", apiEnabled: true, contactEmail: "ops@lufthansa-cargo.example", isActive: true },
    { carrierCode: "QR", carrierName: "Qatar Airways Cargo", mode: "AIR", serviceTypes: ["AIR_GEN"], reliabilityScore: 93, contractTier: "CONTRACT", apiEnabled: true, contactEmail: "ops@qatar-cargo.example", isActive: true },
    { carrierCode: "DHL", carrierName: "DHL Express", mode: "AIR", serviceTypes: ["AIR_EXPRESS"], reliabilityScore: 98, contractTier: "CONTRACT", apiEnabled: true, contactEmail: "ops@dhl-express.example", isActive: true },
    { carrierCode: "FDX", carrierName: "FedEx Express", mode: "AIR", serviceTypes: ["AIR_EXPRESS"], reliabilityScore: 96, contractTier: "CONTRACT", apiEnabled: true, contactEmail: "ops@fedex-express.example", isActive: true },
    { carrierCode: "UPS", carrierName: "UPS Express", mode: "AIR", serviceTypes: ["AIR_EXPRESS"], reliabilityScore: 96, contractTier: "CONTRACT", apiEnabled: true, contactEmail: "ops@ups-express.example", isActive: true },
    { carrierCode: "CONCOR", carrierName: "CONCOR Rail Express", mode: "GROUND", serviceTypes: ["GROUND"], reliabilityScore: 89, contractTier: "CONTRACT", apiEnabled: true, contactEmail: "ops@concor-rail.example", isActive: true },
    { carrierCode: "DBC", carrierName: "DB Cargo", mode: "GROUND", serviceTypes: ["GROUND"], reliabilityScore: 88, contractTier: "CONTRACT", apiEnabled: true, contactEmail: "ops@db-cargo.example", isActive: true },
    { carrierCode: "BNSF", carrierName: "BNSF Railway Intermodal", mode: "GROUND", serviceTypes: ["GROUND"], reliabilityScore: 90, contractTier: "CONTRACT", apiEnabled: true, contactEmail: "ops@bnsf-rail.example", isActive: true },
  ],
  serviceTypes: [
